...
settingsButton.Image = "rbxassetid://3926305904" -- ícono genérico de engranaje
...
configTitle.Text = "Configuración del Executor"
configTitle.Font = Enum.Font.GothamBold
configTitle.TextSize = 18
configTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
configTitle.Parent = configFrame

local v1ModeButton = Instance.new("TextButton")
v1ModeButton.Size = UDim2.new(0, 260, 0, 40)
v1ModeButton.Position = UDim2.new(0.5, -130, 0.18, 0)
v1ModeButton.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
v1ModeButton.Text = "Executor V1 (Normal)"
v1ModeButton.Font = Enum.Font.GothamBold
v1ModeButton.TextSize = 16
v1ModeButton.TextColor3 = Color3.fromRGB(255, 255, 255)
v1ModeButton.Parent = configFrame

local v2ModeButton = Instance.new("TextButton")
v2ModeButton.Size = UDim2.new(0, 260, 0, 40)
v2ModeButton.Position = UDim2.new(0.5, -130, 0.32, 0)
v2ModeButton.BackgroundColor3 = Color3.fromRGB(0, 122, 255)
v2ModeButton.Text = "Executor V2 (Hubs / Scripts)"
v2ModeButton.Font = Enum.Font.GothamBold
v2ModeButton.TextSize = 16
v2ModeButton.TextColor3 = Color3.fromRGB(255, 255, 255)
v2ModeButton.Parent = configFrame

local defaultThemeButton = Instance.new("TextButton")
defaultThemeButton.Size = UDim2.new(0, 260, 0, 40)
defaultThemeButton.Position = UDim2.new(0.5, -130, 0.46, 0)
defaultThemeButton.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
defaultThemeButton.Text = "Tema Normal"
defaultThemeButton.Font = Enum.Font.GothamBold
defaultThemeButton.TextSize = 16
defaultThemeButton.TextColor3 = Color3.fromRGB(255, 255, 255)
defaultThemeButton.Parent = configFrame

local neonButton = Instance.new("TextButton")
neonButton.Size = UDim2.new(0, 260, 0, 40)
neonButton.Position = UDim2.new(0.5, -130, 0.60, 0)
neonButton.BackgroundColor3 = Color3.fromRGB(255, 100, 0)
neonButton.Text = "Tema Neon Halloween 🎃"
neonButton.Font = Enum.Font.GothamBold
neonButton.TextSize = 16
neonButton.TextColor3 = Color3.fromRGB(255, 255, 255)
neonButton.Parent = configFrame

local hackerButton = Instance.new("TextButton")
hackerButton.Size = UDim2.new(0, 260, 0, 40)
hackerButton.Position = UDim2.new(0.5, -130, 0.74, 0)
hackerButton.BackgroundColor3 = Color3.fromRGB(0, 160, 0)
hackerButton.Text = "Tema Hacker"
hackerButton.Font = Enum.Font.GothamBold
hackerButton.TextSize = 16
hackerButton.TextColor3 = Color3.fromRGB(255, 255, 255)
hackerButton.Parent = configFrame

local xmasButton = Instance.new("TextButton")
xmasButton.Size = UDim2.new(0, 260, 0, 40)
xmasButton.Position = UDim2.new(0.5, -130, 0.88, 0)
xmasButton.BackgroundColor3 = Color3.fromRGB(200, 0, 0)
xmasButton.Text = "Tema Navidad 🎄"
xmasButton.Font = Enum.Font.GothamBold
xmasButton.TextSize = 16
xmasButton.TextColor3 = Color3.fromRGB(255, 255, 255)
xmasButton.Parent = configFrame

----------------------------------------------------------------------
-- MODO V2: Hubs + Scripts (con páginas)
----------------------------------------------------------------------
...
----------------------------------------------------------------------
-- LISTA DE SCRIPTS (PAGINADO, 3 PÁGINAS CON 9 SCRIPTS)
----------------------------------------------------------------------
local scriptsList = {
    -- PÁGINA 1 (1–4)
    {
...
local function createScriptsPage()
    ...
    pageLabel.Text = "Página " .. currentScriptPage .. "/" .. totalPages
...
keyInfo.Text = "Obtén la key desde la página, cópiala y pégala aquí para desbloquear el executor."
...
keyUrlLabel.Text = "direct-link.net (copiado al usar el botón)"
...
verifyKeyButton.MouseButton1Click:Connect(function()
    if keyBox.Text == correctKey then
        ...
        keyBox.Text = ""
        keyBox.PlaceholderText = "Key incorrecta, inténtalo de nuevo"
    end
end)
...
local function applyTheme()
    ...
    elseif currentTheme == "neon" then
        ...
        effectLabel.Text = "🎃 HALLOWEEN NEON MODE 🎃"
